...
add_action('wp_enqueue_scripts', 'inspiredtouch_scripts', 100);
function inspiredtouch_scripts(){
  wp_register_script(
    'bootstrap-script', 
...
add_action('wp_enqueue_scripts', 'inspiredtouch_styles');
...
function inspiredtouch_header_fallback_menu(){ ?>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li<?php if(is_page('sign-services')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('sign-services'); ?>">Sign Services</a></li>
          <li<?php if(is_page('graphic-design')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('graphic-design'); ?>">Graphic Design</a></li>
          <li<?php if(is_page('other-services')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('other-services'); ?>">Other</a></li>
        </ul>
      </li>
